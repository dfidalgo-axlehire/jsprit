 ...
 */
class ParallelInsertionNoiseMaker implements SoftActivityConstraint, ParallelIterationStartsListener {
...
//    private Random[] randomArray;
    ...
    ParallelInsertionNoiseMaker(VehicleRoutingProblem vrp, double maxCosts, double noiseLevel, double noiseProbability) {
