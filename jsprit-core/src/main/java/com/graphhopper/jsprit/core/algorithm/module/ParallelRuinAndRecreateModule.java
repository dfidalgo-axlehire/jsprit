...
public class ParallelRuinAndRecreateModule implements SearchStrategyModule {
    ...
    public ParallelRuinAndRecreateModule(String moduleName, InsertionStrategy insertion, RuinStrategy ruin, String id, RedissonClient redisson) {
        super();
