 ...
 */
class ParallelConcurrentInsertionNoiseMaker implements SoftActivityConstraint, ParallelIterationStartsListener {
    ...
    ParallelConcurrentInsertionNoiseMaker(VehicleRoutingProblem vrp, double maxCosts, double noiseLevel, double noiseProbability) {
