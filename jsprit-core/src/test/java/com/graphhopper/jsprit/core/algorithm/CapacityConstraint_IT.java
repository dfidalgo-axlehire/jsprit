...
//            System.out.println("cap: " + capacityDimensions);
            ...
            assertTrue(loadAtBeginning.isLessOrEqual(capacityDimensions));
        }
//
        assertTrue(solution.getRoutes().size() != 1);

    }

    @Test
    public void capacityShouldNotBeExceeded_parallel() {
        ...
        IntStream.range(0,20).parallel().forEach((i) -> {
            ParallelVehicleRoutingAlgorithm vra = ParallelJsprit.Builder.newInstance(vrp)
                                                                        ...
                                                                        .setProperty(Parameter.VEHICLE_SWITCH, "true")
                                                                        .buildAlgorithm();
